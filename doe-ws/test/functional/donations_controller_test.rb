...
class DonationsControllerTest < ActionController::TestCase
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post :create, donation: { donation_date: @donation.donation_date, donation_description: @donation.donation_description }
    end
  ...
  test "should update donation" do
    put :update, id: @donation, donation: { donation_date: @donation.donation_date, donation_description: @donation.donation_description }
    assert_redirected_to donation_path(assigns(:donation))
  end
